...
Route::prefix('manage')->group(function(){
        ...
        Route::post('/manage/login', 'login')->name('admin.login.submit');
    ...
    Route::controller(BlogController::class)->group(function(){
        Route::get('/blog/index', 'NewsController@Index')->name('admin.news.index');
        Route::get('/blog/create/', 'NewsController@Create')->name('admin.news.create');
        Route::post('/blog/store', 'NewsController@Store');
        Route::get('/blog/edit/{id}', 'NewsController@Edit')->name('admin.edit.news');
        Route::post('/blog/update/{id}', 'NewsController@Update');
        Route::post('/blog/status/{id}', 'NewsController@status')->name('news.status');
    });
