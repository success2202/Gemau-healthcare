                ...
                <div class="">
                    ...
                    <div class="pi ps-btn--success">
                        <div class="container" style="text-align: center">
                            <p class="m-0" style="color:#fff;"> <img src="{{asset('images/products/'.$product->image_path)}}" style="width:30px; height:30px" alt="{{asset('images/products/'.$product->image_path)}}" /> {{$product->name}} Added to Cart Successfully</p>
                        </div>
                    </div>
               </div>
            </div>
