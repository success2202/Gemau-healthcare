            ...
            <div class="row">
              ...
              <div class="card">
                                      ...
                                      <input type="text" name="name" placeholder=" Name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" >
                                         ...
                                         <div class="col-md-6">
                                          <div class="custom-file">
                                                    ...
                                                    <small id="emailHelp" class="form-text text-muted">Upload Team Image
                                                    </small>
                                                      @error('image')
                                                    <span class="invalid-feedback"> <small> *</small> </span>
                                                    @enderror
                                         ...
                                         <input type="text" name="title" placeholder="title" value="{{old('title')}}" class="form-control @error('title') is-invalid @enderror" >
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea id="summernote" class="@error('description') is-invalid @enderror" name="description"></textarea>
                                           
                                                    <small id="emailHelp" class="form-text text-muted">Team
                                                    </small>
                                                    @error('description')
                                                    <span class="invalid-feedback"> <small> * </small> </span>
                                                    @enderror
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                        <div class="p-5">
                             <button type="submit" class="text-center btn btn-primary w-100 p-3 ">Add New Team</button>
                           </div>
                           </div>
                           </div>
                        </div>
